...
import 'package:diaryappp/Relax/constants.dart';
import 'widget/vdoPage1.dart';
...
class MonkPage extends StatelessWidget {
  @override
        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
              color: Color.fromRGBO(255, 177, 190, 1),
                      ...
                      children: <Widget>[
                        SeassionCard(
                          ...
                          press: () {Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => vdoPage1()),
                          );},
                        ),
                        SeassionCard(
                          seassionNum: 2,
          ...
          Padding(
            padding: EdgeInsets.only(top: 700,left: 150),
            child: Row(
              children: <Widget>[
                RaisedButton(
                  onPressed: (){
