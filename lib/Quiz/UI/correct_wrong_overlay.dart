          ...
          children: <Widget>[
            new Container(
              ...
              child: new Transform.rotate(
                angle: _iconAnimation.value * 2 * 7.14,
                child: new Icon(widget._isCorrect == true ? Icons.skip_next : Icons.done, size: _iconAnimation.value * 80.0,),
              ),
            ),
            new Padding(
              padding: new EdgeInsets.only(bottom: 20.0),
            ),
            new Text(widget._isCorrect == true ? "Next!" : "Good!", style: new TextStyle(color: Colors.white, fontSize: 30.0),)
          ],
        ),
      ),
    );
